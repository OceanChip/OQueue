...
{
    public class DeleteConsumerGroupForClusterRequestHandler : AbstractRequestHandler<DeleteConsumerGroupForClusterRequest>
    {
        public DeleteConsumerGroupForClusterRequestHandler(NameServerController nameServerController) : base(nameServerController)
        {
        }

        protected override byte[] Process(IRequestHandlerContext context, DeleteConsumerGroupForClusterRequest request)
        {
