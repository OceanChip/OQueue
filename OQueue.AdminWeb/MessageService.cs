...
namespace OQueue.AdminWeb
{
    public class MessageService
    {
        ...
        {
            var remotingClient = GetAvailableNameServerRemotingClient();
            var requestData = _binarySerializer.Serialize(new OceanChip.Queue.Protocols.NameServers.Requests.GetTopicQueueInfoRequest
            {
        ...
        {
            var remotingClient = GetBrokerByName(clusterName, brokerName);
            var requestData = _binarySerializer.Serialize(new OceanChip.Queue.Protocols.Brokers.Requests.GetTopicQueueInfoRequest(topic));
        ...
        {
            var remotingClient = GetAvailableNameServerRemotingClient();
            var requestData = _binarySerializer.Serialize(new OceanChip.Queue.Protocols.NameServers.Requests.GetTopicConsumeInfoRequest
            {
                ClusterName = clusterName,
                ConsumerGroup = group,
                Topic = topic
        ...
        {
            var remotingClient = GetBrokerByName(clusterName, brokerName);
            var requestData = _binarySerializer.Serialize(new OceanChip.Queue.Protocols.Brokers.Requests.GetTopicConsumeInfoRequest(group, topic));
        ...
        {
            var remotingClient = GetAvailableNameServerRemotingClient();
            var requestData = _binarySerializer.Serialize(new OceanChip.Queue.Protocols.NameServers.Requests.GetConsumerListRequest
            {
                ClusterName = clusterName,
                ConsumerGroup = group,
                Topic = topic
        ...
        {
            var remotingClient = GetBrokerByName(clusterName, brokerName);
            var requestData = _binarySerializer.Serialize(new OceanChip.Queue.Protocols.Brokers.Requests.GetConsumerListRequest(group, topic));
