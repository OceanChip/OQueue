...
using OQueue.AdminWeb.Models;

namespace OQueue.AdminWeb.Controllers
{
    [HandleError]
    public class BrokerController : Controller
    {
        ...
        public ActionResult DeletOQueue(string clusterName, string brokerName, string topic, int queueId)
        {
            ViewBag.ClusterName = clusterName;
            ViewBag.BrokerName = brokerName;
